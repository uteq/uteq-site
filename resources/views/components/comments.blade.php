<div class="bg-secondary py-32">
    <div class="max-w-5xl mx-auto px-6">
        ...
        <p class="font-sregs-bold text-white text-6xl tracking-wider text-center leading-[3.5rem] my-24">"Ontzettend leuk team die bouwt aan innovatieve en slimme oplossingen."</p>
