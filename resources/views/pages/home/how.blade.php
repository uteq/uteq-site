<div class="relative bg-secondary w-full py-24 lg:py-32 overflow-hidden" id="werkwijze">
    ...
    <div class="max-w-6xl mx-auto px-8 relative">
        ...
        {{-- Drie stappen als cards --}}
        <div class="grid md:grid-cols-3 gap-6">

            {{-- Stap 1 --}}
            <div data-aos="fade-up" class="card-tilt rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10 hover:border-primary/20 transition-colors duration-500">
                <span class="text-5xl md:text-6xl font-extrabold text-primary/20 leading-none block mb-8">01</span>
            ...
            {{-- Stap 2 --}}
            <div data-aos="fade-up" data-aos-delay="80" class="card-tilt rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10 hover:border-primary/20 transition-colors duration-500">
                <span class="text-5xl md:text-6xl font-extrabold text-primary/20 leading-none block mb-8">02</span>
            ...
            {{-- Stap 3 --}}
            <div data-aos="fade-up" data-aos-delay="160" class="card-tilt rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10 hover:border-primary/20 transition-colors duration-500">
                <span class="text-5xl md:text-6xl font-extrabold text-primary/20 leading-none block mb-8">03</span>
