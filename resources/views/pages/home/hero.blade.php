<div class="relative isolate px-6 pt-14 lg:px-8 bg-secondary overflow-hidden">
    ...
    {{-- Dot grid (zichtbaar rondom logo mark, vervaagt naar links) --}}
    ...
    <div class="relative mx-auto max-w-6xl pb-24 pt-16 sm:pb-32 sm:pt-24 lg:pb-40 lg:pt-28">
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="md:w-3/5 text-center md:text-left">
                <h1 data-aos="fade-up" class="font-sregs-bold text-4xl md:text-5xl lg:text-6xl text-white tracking-wide leading-tight md:leading-tight lg:leading-tight mb-6">
                    Software die <span class="text-primary">werkt.</span><br class="hidden md:block">Zoals jij <span class="text-primary">werkt.</span>
                </h1>

                <p data-aos="fade-up" data-aos-delay="100" class="text-lg md:text-xl text-gray-300 max-w-2xl mb-10 leading-relaxed">
                    Maatwerk software voor zakelijke dienstverleners. Vaste prijs. Geen verrassingen.
                </p>

                <div data-aos="fade-up" data-aos-delay="200">
                    <x-contact-form-modal title="Vraag een kennismakingsgesprek aan">
                        <button class="btn-shimmer rounded-xl bg-primary px-8 py-4 md:px-10 md:py-5 md:text-lg font-semibold text-secondary shadow-sm hover:bg-primary/90 hover:shadow-[0_0_36px_rgba(1,220,130,0.45)] hover:scale-[1.02] transition-all duration-300">
            ...
            {{-- Visual rechts: het mark als lichtbron --}}
            <div data-aos="fade-left" data-aos-delay="300" class="md:w-2/5 hidden md:flex items-center justify-center">
                <div class="relative w-64 h-64 lg:w-80 lg:h-80">
                    {{-- Één rustige ring --}}
                    <div class="hero-ring" aria-hidden="true"></div>

                    {{-- Het mark --}}
                    <svg class="hero-logo-svg w-full h-full" viewBox="0 0 65 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- Gradient halo achter het mark --}}
                    <div class="absolute inset-0 bg-gradient-to-tr from-primary/10 to-transparent rounded-full blur-3xl -z-10"></div>
                </div>
            </div>
        </div>

        {{-- Client logos marquee --}}
        <div data-aos="fade-up" data-aos-delay="400" class="mt-16 pt-10 border-t border-white/10">
            <p class="text-gray-500 text-xs uppercase tracking-widest mb-5 text-center md:text-left">Wij werken onder andere voor</p>
            <div class="overflow-hidden">
                <div class="marquee-track gap-x-16 items-center">
                    {{-- Set 1 --}}
                    <span class="text-gray-400 text-sm font-semibold uppercase tracking-[0.15em] whitespace-nowrap">CivilGrow</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-bold uppercase tracking-[0.2em] whitespace-nowrap">Noorderinzicht</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-semibold uppercase tracking-[0.12em] whitespace-nowrap">De Goede Advies</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-extrabold uppercase tracking-[0.18em] whitespace-nowrap">Kubus</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-semibold uppercase tracking-[0.15em] whitespace-nowrap">Biobase</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-bold uppercase tracking-[0.25em] whitespace-nowrap">Easie</span>
                    <span class="text-gray-600 text-xs mx-8" aria-hidden="true">·</span>
                    {{-- Set 2 (exact duplicate voor naadloze loop) --}}
                    <span class="text-gray-400 text-sm font-semibold uppercase tracking-[0.15em] whitespace-nowrap">CivilGrow</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
                    <span class="text-gray-400 text-sm font-bold uppercase tracking-[0.2em] whitespace-nowrap">Noorderinzicht</span>
                    <span class="text-gray-600 text-xs mx-1" aria-hidden="true">·</span>
