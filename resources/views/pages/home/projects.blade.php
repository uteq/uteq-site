<div class="bg-[#F9F8F8]" id="projects">
        ...
        <div class="flex flex-col md:flex-row gap-x-12 gap-y-6 pb-12">
            ...
            <div class="md:w-1/2">
                <div class="flex flex-col gap-3">
                    ...
                    <div class="">
                        <span class="w-fit whitespace-nowrap md:mr-2 mb-2 inline-flex items-center rounded-full bg-gray-100 px-4 py-2 font-medium text-gray-500">Programming</span>
                        <span class="w-fit whitespace-nowrap md:mr-2 inline-flex items-center rounded-full bg-gray-100 px-4 py-2 font-medium text-gray-500">Koppeling</span>
                        <span class="w-fit whitespace-nowrap md:mr-2 inline-flex items-center rounded-full bg-gray-100 px-4 py-2 font-medium text-gray-500">Telegram</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="md:w-1/2">
                <div class="flex flex-col gap-3">
                    ...
                    <p class="leading-8 pb-2">
                        ...
                        <a href="https://safesent.nl" class="inline-flex gap-2 items-center mt-4" target="_blank">
                            <span class="border-b border-primary">Bekijk safesent.nl</span>
