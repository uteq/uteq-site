<div class="py-32 bg-floral-white" id="services">
    <div class="max-w-6xl mx-auto px-8 lg:px-0">
        <div class="text-4xl md:text-5xl font-sregs-bold flex justify-center pb-20">
            Onze Diensten
        </div>
        ...
        <div class="flex flex-col gap-20">
            ...
            <div class="flex max-w-xl lg:max-w-full mx-auto lg:mx-0 flex-col lg:flex-row gap-6 lg:gap-14">
                <div class="lg:w-1/2 order-2 md:order-2 flex flex-col gap-4 my-auto">
                    ...
                    <div class="leading-7">Onze notificatiesystemen fungeren als jouw betrouwbare informatiekanaal, waardoor je bedrijf altijd goed geïnformeerd is over cruciale gebeurtenissen en veranderingen.<br><br> Of het nu gaat om belangrijke meldingen van klanten, essentiële statusupdates van je systemen of andere waardevolle informatie, onze notificatiesystemen zijn er om je bedrijf soepel te laten draaien door de juiste informatie op het juiste moment te leveren.</div>
                    <div>
                        <a href="#contact" class="rounded-xl bg-primary px-8 py-4 font-semibold text-white shadow-sm inline-flex gap-2 items-center">
                            Maak een afspraak
                        </a>
